...
export default async function AuditManagePage() {
    ...
    async function deleteByFilter(formData: FormData) {
        ...
        const periodId =
            year !== undefined
                ? (await prisma.period.findUnique({ where: { year }, select: { id: true } }))?.id
                : undefined;
            ...
            <div className={styles.header}>
                <div>
                    ...
                    <div className={styles.muted}>
                        Admin-Funktionen: Einträge/Runs löschen oder kompletten Audit Log leeren
                    </div>
                </div>
            ...
            <div className={styles.card}>
                <div className={styles.row}>
                    <div>
                        ...
                        <div className={styles.muted}>
                            Hinweis: Löschen entfernt Historie unwiderruflich.
                        </div>
                    </div>
            ...
            <div className={styles.card}>
                <div className={styles.row}>
                    <div>
                        ...
                        <div className={styles.muted}>
                            Sicherheit: Ohne Filter wird nichts gelöscht. Bestätige mit „LÖSCHEN“.
                        </div>
                    </div>
                </div>
