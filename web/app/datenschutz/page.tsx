...
export default function DatenschutzPage() {
  return (
    <PublicPageShell title="Datenschutzerklärung">
      ...
      <p>
        Auf der Landing Page können Metabase-Dashboards/Fragen als externe Inhalte eingebunden werden. Diese Inhalte werden erst nach Ihrer
        Zustimmung geladen.
      </p>

      <h2>6. Cookies / Einwilligung</h2>
      <p>
        Für das Laden externer Metabase-Inhalte wird eine Einwilligung gespeichert (Cookie) damit die Entscheidung beim nächsten Besuch
        nicht erneut abgefragt werden muss.
      </p>
